...
st.markdown("""
    <style>
        ...
        .user {
            background-color: #262730 !important;    /* grey bubble */
            text-align: right;
        }
        .bot {
            background-color: #262730 !important;    /* grey bubble */
...
if submitted and user_input:
    ...
    if memory_enabled:
        messages = [{"role": "system", "content": "You are an Ai assistant(LLM). Your Founder is 'Shabbir Hardwarewala'. Founder's Email: hushab94@gmail.com "}]
        messages += st.session_state.chat_history
        messages.append({"role": "user", "content": user_input})
    else:
        messages = [
            {"role": "system", "content": "You are an Ai assistant(LLM). Your Founder is 'Shabbir Hardwarewala'. Founder's Email: hushab94@gmail.com "},
